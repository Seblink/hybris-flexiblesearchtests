...
public class DefaultFlexiblesearchtestsService implements FlexiblesearchtestsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultFlexiblesearchtestsService.class);
	...
	{
		return DefaultFlexiblesearchtestsService.class.getResourceAsStream("/flexiblesearchtests/sap-hybris-platform.png");
	}
