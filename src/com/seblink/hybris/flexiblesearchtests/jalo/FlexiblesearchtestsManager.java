 ...
 */
package com.seblink.hybris.flexiblesearchtests.jalo;
...
/**
 * This is the extension manager of the Flexiblesearchtests extension.
 */
public class FlexiblesearchtestsManager extends GeneratedFlexiblesearchtestsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(FlexiblesearchtestsManager.class);
	 ...
	 */
	public static FlexiblesearchtestsManager getInstance()
	{
		return (FlexiblesearchtestsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(FlexiblesearchtestsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FlexiblesearchtestsManager() // NOPMD 
	{
		LOG.debug("constructor of FlexiblesearchtestsManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of FlexiblesearchtestsManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of FlexiblesearchtestsManager called, current tenant: {}", getTenant().getTenantID());
	}
