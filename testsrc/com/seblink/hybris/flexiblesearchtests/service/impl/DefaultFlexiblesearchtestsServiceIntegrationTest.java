...
import com.seblink.hybris.flexiblesearchtests.service.impl.DefaultFlexiblesearchtestsService;
 ...
 */
@IntegrationTest
public class DefaultFlexiblesearchtestsServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "flexiblesearchtestsPlatformLogo";

		// when
		final String logoUrl = flexiblesearchtestsService.getHybrisLogoUrl(logoCode);
